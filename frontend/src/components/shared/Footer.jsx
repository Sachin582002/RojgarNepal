    ...
    <footer className="border-t border-t-gray-200 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          {/* <img src="rn logo.png" alt="Logo"></img> */}
            <h2 className='text-2xl font-bold'>Rojgar<span className='text-[#F83002]'>Nepal</span></h2>
            <p className="text-sm">© 2024 Rojgar Nepal | All rights reserved.</p>
          </div>
